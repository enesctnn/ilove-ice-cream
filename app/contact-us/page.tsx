...
function ContactUsPage() {
  return (
    <div className="w-full h-[800px] lg:!h-screen relative bg-ellipse from-pink-300 to-rose-900 flex items-center justify-center">
      <article
        className={cn(
          'flex flex-col gap-10 border-[3px] outline outline-[3px] outline-custom-red-300 outline-offset-4 border-custom-red-300 scale-75 h-[400px] w-[500px] lg:h-[600px] lg:w-[840px] 2xl:scale-150 lg:scale-100 leading-relaxed bg-ellipse from-custom-red-100 to-custom-red-400 p-5 lg:p-20 z-40 relative text-white mt-40 lg:!mt-28',
          font.className
        )}
      >
        <div className="space-y-4 text-xl lg:text-4xl">
          <p>
        ...
        <div className="flex items-start justify-between">
          <div className="lg:w-full lg:text-xl lg:space-y-3">
            <p>
              Email:{' '}
              <a
